...
{
    public partial class UC_Thamdinh_Duyet_Yeucaubosung : CB_Thamdinh_Duyet_Chitiet, I_UC_Thamdinh_Duyet_Chitiet
    {
        public UC_Thamdinh_Duyet_Yeucaubosung()
        {
            InitializeComponent();
        }

        private void UC_Thamdinh_Duyet_Yeucaubosung_Load(object sender, EventArgs e)
        {
