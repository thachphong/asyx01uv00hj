...
{
    public partial class FRM_TD_ThuchienNhiemvu_Tepdinhkem : BaseForm_Data
    {
        FRM_TD_ThuchienNhiemvu frm = null;
        List<DM_Huongdan> currentList = null;
        public string currentState = "NORMAL";
        public FRM_TD_ThuchienNhiemvu_Tepdinhkem()
        {
            InitializeComponent();
        }

        private void FRM_TD_ThuchienNhiemvu_Tepdinhkem_Load(object sender, EventArgs e)
        {
