...
{
    public partial class FRM_TD_Thamdinh : Form
    {
        ...
        public FRM_TD_Thamdinh()
        {
            InitializeComponent();
        }

        private void FRM_TD_Thamdinh_Load(object sender, EventArgs e)
        {
        ...
        {
            TD_Thamdinh_Filter filter = new TD_Thamdinh_Filter();
            filter.Nam = lookUpEdit6.EditValue == null ? 0 : int.Parse(lookUpEdit6.EditValue.ToString());
            filter.Donviphancong = lookUpEdit7.EditValue == null ? Guid.Empty : Guid.Parse(lookUpEdit7.EditValue.ToString());
            filter.DanhmucNhiemvu = lookUpEdit8.EditValue == null ? Guid.Empty : Guid.Parse(lookUpEdit8.EditValue.ToString());
            filter.LoaiThutuc = lookUpEdit1.EditValue == null ? Guid.Empty : Guid.Parse(lookUpEdit1.EditValue.ToString());
            filter.PhanloaiNhiemvu = lookUpEdit2.EditValue == null ? Guid.Empty : Guid.Parse(lookUpEdit2.EditValue.ToString());
            filter.Trangthai = lookUpEdit3.EditValue == null ? Guid.Empty : Guid.Parse(lookUpEdit3.EditValue.ToString());
            filter.Nguoiphancong = nguoisudungID;

            currentList = Helpers.TrinhduyetThuchienNhiemvu.GetList_For_Thamdinh(filter);
